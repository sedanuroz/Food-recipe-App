...
class HamurIsleri extends StatefulWidget {
  @override
  _HamurIsleriState createState() => _HamurIsleriState();
}

class _HamurIsleriState extends State<HamurIsleri> {
  List<dynamic> hamurIsleri = []; // JSON'dan veri alacağız
  bool isLoading = true;

  // JSON dosyasını yükleme fonksiyonu
  Future<void> loadJson() async {
    final String response = await rootBundle.rootBundle.loadString('assets/baslangicler/hamurİsleri/hamurİsleri.json');
    final data = json.decode(response); // JSON verisini decode et
    setState(() {
      hamurIsleri = data; // JSON verisini listeye at
          ...
          children: [
            ...
            Expanded(
              child: isLoading
                  ...
                  : ListView.builder(
                itemCount: hamurIsleri.length,
                itemBuilder: (context, index) {
                  var hamurIslemi = hamurIsleri[index];
                  return Card(
                    ...
                    child: ListTile(
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(hamurIslemi['image_url']),
                      ...
                      subtitle: Text(
                        "${hamurIslemi['calories'][0]['calorie']}",
